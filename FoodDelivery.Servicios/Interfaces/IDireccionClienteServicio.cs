...
{
    Task<DireccionClienteDTO> CrearDireccionClienteAsync(DireccionClienteCreateDTO direccionDto);
    Task<DireccionClienteDTO> ActualizarDireccionClienteAsync(int idDireccionCliente, Guid idCliente, DireccionClienteUpdateDTO direccionDto);
